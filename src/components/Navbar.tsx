...
const Navbar = () => {
  ...
  return (
    <div className="flex justify-center w-full py-6 px-4 fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-sm">
      <div className="flex items-center justify-between px-6 py-3 bg-card rounded-full shadow-card w-full max-w-3xl relative z-10 border border-border">
        <div className="flex items-center">
          ...
          >
            ...
            <span className="text-xl font-black text-foreground">Habilita</span>
          </motion.div>
        </div>
