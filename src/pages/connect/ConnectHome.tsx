      ...
      <div className="min-h-screen bg-connect-surface">
          ...
          <div className="container mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              <Link to="/connect" className="flex items-center gap-3 group">
                <img src="/logo-vrumi.png" alt="Vrumi Connect" className="h-16 w-auto" />
        ...
        <section className="container mx-auto px-4 py-16">
          ...
          opacity: 1
            ...
            </motion.div> : <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6" style={{
          perspective: "1500px"
        }}>
        ...
        <section className="bg-white py-20">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto" style={{
            perspective: "1000px"
          }}>
