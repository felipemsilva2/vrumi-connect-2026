            ...
            <div className="max-w-6xl mx-auto px-4 -mt-10 grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <Card className="shadow-lg border-0">
                        ...
                        <CardContent className="text-gray-600 dark:text-gray-300 space-y-4 leading-relaxed">
                            <p>
                    ...
                    <div className="space-y-4">
                        <h2 className="text-2xl font-bold text-gray-800 dark:text-white px-2">Perguntas Frequentes</h2>
                        <Accordion type="single" collapsible className="w-full bg-white dark:bg-gray-900 rounded-xl shadow-sm px-4">
                ...
                <div className="lg:col-span-1 space-y-6">
                    <div className="sticky top-6">
                        ...
                        <div className="mt-6 bg-white dark:bg-gray-900 p-6 rounded-xl shadow-md border border-gray-100 dark:border-gray-800">
