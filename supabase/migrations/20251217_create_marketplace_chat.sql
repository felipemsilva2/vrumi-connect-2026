...
-- 7. Realtime configuration (must be enabled explicitly in Supabase dashboard for these tables)
-- Adding them to the realtime publication
...
-- 8. Trigger to update last_message in chat_rooms
